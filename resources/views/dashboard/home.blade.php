    ...
    <div class="group-data-[sidebar-size=lg]:ltr:md:ml-vertical-menu group-data-[sidebar-size=lg]:rtl:md:mr-vertical-menu group-data-[sidebar-size=md]:ltr:ml-vertical-menu-md group-data-[sidebar-size=md]:rtl:mr-vertical-menu-md group-data-[sidebar-size=sm]:ltr:ml-vertical-menu-sm group-data-[sidebar-size=sm]:rtl:mr-vertical-menu-sm pt-[calc(theme('spacing.header')_*_1)] pb-[calc(theme('spacing.header')_*_0.8)] px-4 group-data-[navbar=bordered]:pt-[calc(theme('spacing.header')_*_1.3)] group-data-[navbar=hidden]:pt-0 group-data-[layout=horizontal]:mx-auto group-data-[layout=horizontal]:max-w-screen-2xl group-data-[layout=horizontal]:px-0 group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:ltr:md:ml-auto group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:rtl:md:mr-auto group-data-[layout=horizontal]:md:pt-[calc(theme('spacing.header')_*_1.6)] group-data-[layout=horizontal]:px-3 group-data-[layout=horizontal]:group-data-[navbar=hidden]:pt-[calc(theme('spacing.header')_*_0.9)]">
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Beranda HG BABY CRM APP</h5>
                </div>
            ...
            <div class="grid grid-cols-12 2xl:grid-cols-12 gap-x-5">
                    ...
                    <div class="relative card-body">
                        <div class="grid items-center grid-cols-12">
                            <div class="col-span-12 lg:col-span-8 2xl:col-span-8">
                                ...
                                <p class="mb-5 text-slate-400">HG BABY CRM APP adalah sistem informasi CRM (Customer Realtionship Management) yang dibuat khusus untuk membantu pengelolaan data di toko HG BABY KIDS. Saat ini khusus untuk diterapkan untuk menghitung nilai Diskon untuk tiap pelanggan secara otomatis berbasis metode FUZZY LOGIC</p>
                                <a href="https://web.facebook.com/HGBABYKIDS/" class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-500/20 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-500/20 dark:ring-custom-400/20">Kunjungi Facebook HG BABY KIDS</a>
                            </div>
                ...
                <div class="col-span-12 card md:col-span-6 lg:col-span-4 2xl:col-span-2">
                    <div class="text-center card-body">
                        ...
                        <h5 class="mt-4 mb-2"><span class="counter-value" data-target="{{$count_customer}}">0</span></h5>
                        <p class="text-slate-500 dark:text-zink-200">Jumlah Member</p>
                    </div>
                </div><!--end col-->
                ...
                <div class="col-span-12 card md:col-span-6 lg:col-span-4 2xl:col-span-2">
                    <div class="text-center card-body">
                        ...
                        <h5 class="mt-4 mb-2"><span class="counter-value" data-target="{{$count_transaction}}">0</span></h5>
                ...
                <div class="col-span-12 card md:col-span-6 lg:col-span-4 2xl:col-span-2">
                    <div class="text-center card-body">
                        ...
                        <h5 class="mt-4 mb-2"><span class="counter-value" data-target="{{$member_transaction}}">0</span></h5>
                        <p class="text-slate-500 dark:text-zink-200">Transaksi Member</p>
                    </div>
                </div><!--end col-->
                ...
                <div class="col-span-12 card md:col-span-6 lg:col-span-4 2xl:col-span-2">
                    <div class="text-center card-body">
                        ...
                        <h5 class="mt-4 mb-2">Rp. <span class="counter-value" data-target="{{$total_transaction}}">0</span></h5>
                        <p class="text-slate-500 dark:text-zink-200">Total Nominal Transaksi</p>
                    </div>
                </div><!--end col-->
                ...
                <div class="col-span-12 card md:col-span-6 lg:col-span-4 2xl:col-span-2">
                    ...
                    <div class="flex items-center justify-center mx-auto text-red-500 bg-red-100 rounded-full size-14 dark:bg-red-500/20">
                        ...
                        <h5 class="mt-4 mb-2">Rp. <span class="counter-value" data-target="{{$average_transaction}}">0</span></h5>
                        <p class="text-slate-500 dark:text-zink-200">Rata-rata Nominal Transaksi</p>
                    </div>
                </div><!--end col-->
                ...
                <div class="col-span-12 card md:col-span-6 lg:col-span-4 2xl:col-span-2">
                    ...
                    <div class="flex items-center justify-center mx-auto text-green-500 bg-green-100 rounded-full size-14 dark:bg-green-500/20">
                        ...
                        <h5 class="mt-4 mb-2">Rp. <span class="counter-value" data-target="{{$total_member_transaction}}">0</span></h5>
                        <p class="text-slate-500 dark:text-zink-200">Total Nominal Transaksi Member</p>
                    </div>
                </div><!--end col-->
                ...
                <div class="col-span-12 card 2xl:col-span-12">
                    <div class="card-body">
                        <div class="flex flex-col gap-4 mb-4 md:mb-3 md:items-center md:flex-row">
                            <h6 class="grow text-15">Grafik Pendapatan</h6>
                            <div class="relative">
                        ...
                        <div class="grid grid-cols-12 gap-4 mb-3">
                            <div class="col-span-12 md:col-span-6 lg:col-span-3">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="grow">
                                        <p class="mb-1 text-slate-500 dark:text-zink-200">Total Penjualan</p>
                                        <h5 class="text-15">Rp. <span class="counter-value" data-target="{{$total_transaction}}">0</span></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-span-12 md:col-span-6 lg:col-span-3">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="grow">
                                        ...
                                        <h5 class="text-15">Rp. <span class="counter-value" data-target="746.84">0</span></h5>
                                    </div>
                                </div>
                            </div>
                        </div>

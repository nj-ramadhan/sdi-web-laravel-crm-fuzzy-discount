                    ...
                    <div class="col-span-12 card lg:col-span-6 2xl:col-span-6">
                        <div class="card-body">
                            <div class="flex flex-col gap-2 py-4">
                                ...
                                <input type="text" class="form-control @error('customer_id') is-invalid @enderror" name="customer_id" value="{{ old('customer_id') }}" placeholder="Masukkan ID Pelanggan">                            
                            ...
                            <div class="flex flex-col gap-2 py-4">
                                ...
                                <input type="text" class="form-control @error('amount_transaction') is-invalid @enderror" name="amount_transaction" value="{{ old('amount_transaction') }}" placeholder="Masukkan Nominal Transaksi">
